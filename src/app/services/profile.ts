...
export class Profile { // <-- Nama kelas diubah (sebelumnya ProfileService)
  // Base URL untuk profile API
  private baseApiUrl = `${environment.apiUrl}/Profile`;
  // URL untuk endpoint 'me'
  private apiUrl = `${this.baseApiUrl}/me`;
  ...
  */
  ...
  getAllUsers(): Observable<UserDTO[]> {
    return this.http.get<UserDTO[]>(this.baseApiUrl);
  }
}